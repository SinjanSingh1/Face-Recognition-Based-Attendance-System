...
UPLOAD_FOLDER = r'C:\Users\HP\Desktop\Face-Recognition-Attendance-System-main\IMAGE_FILES'
...
def gen():
    IMAGE_FILES = []
    filename = []
    dir_path = r'C:\Users\HP\Desktop\Face-Recognition-Attendance-System-main\IMAGE_FILES'
    ...
    while True:
        ...
        for encodeFace, faceloc in zip(encode_fasescurrent, fasescurrent):
            matches_face = face_recognition.compare_faces(encodeListknown, encodeFace,TOLERANCE)
